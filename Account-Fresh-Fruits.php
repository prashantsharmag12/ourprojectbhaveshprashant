...
<html>
<head>
<title>Instamart | Vegetables & Fruits</title>
...
<style>
#owl-vegetables-fruits .item img{
    display: block;
    width: 100%;
    height: auto;
}
...
<p align="center"><strong>Vegetables & Fruits</strong></p>
</div>

<div class="tab">
<div id="owl-vegetables-fruits" class="owl-carousel owl-theme">
...
$(document).ready(function() {
  ...
  $("#owl-vegetables-fruits").owlCarousel({
      slideSpeed : 300,
      paginationSpeed : 400,
      items : 2, 
  });
...
<div id="Fresh Vegetables" class="tabcontent" style="background-color: white;">
</br></br>
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price1, price500, price250, price2 FROM FreshVegetables ORDER BY id ASC");
if($results){ 
...
{
$products_item .= <<<EOT
	<form method="post" action="php/cart-fresh-vegetables.php">
	<div class="media">
        <div class="pull-left"> 
...
<div id="Fresh Fruits" class="tabcontent" style="background-color: white;">
</br>
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price1, price500, price250, price2 FROM FreshFruits ORDER BY id ASC");
if($results){ 
$products_item = '<ul class="products">';
//fetch results set as object and output HTML
while($obj = $results->fetch_object())
{
$products_item .= <<<EOT
	<form method="post" action="php/cart-fresh-fruits.php">
	<div class="media">
        <div class="pull-left"> 
           <img style="width: 300px; height: 300px;" class="media-object" src="images/{$obj->product_img_name}" alt="Media Object">
        </div> 
