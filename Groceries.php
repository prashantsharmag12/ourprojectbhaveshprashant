...
<html>
<head>
<title>Instamart | Groceries</title>
...
<p align="center"><strong>Groceries</strong></p>
</div>

<div class="tab">
<div id="owl-groceries" class="owl-carousel owl-theme">
  <div class="item"><button class="tablinks" onclick="openCity(event, 'Dals & Pulse')" id="defaultOpen">Dals & Pulse</button></div>
  <div class="item"><button class="tablinks" onclick="openCity(event, 'Dry Fruits')">Dry Fruits</button></div>
  <div class="item"><button class="tablinks" onclick="openCity(event, 'Edible Oils & Ghee')">Edible Oils & Ghee</button></div>
  <div class="item"><button class="tablinks" onclick="openCity(event, 'Salt, Sugar & Jaggery')">Salt, Sugar & Jaggery</button></div>
  <div class="item"><button class="tablinks" onclick="openCity(event, 'Masalas & Spices')">Masalas & Spices</button></div>
  <div class="item"><button class="tablinks" onclick="openCity(event, 'Tea & Coffee')">Tea & Coffee</button></div>
  <div class="item"><button class="tablinks" onclick="openCity(event, 'Flours & Sooji')">Flours & Sooji</button></div>
  <div class="item"><button class="tablinks" onclick="openCity(event, 'Rice & Poha')">Rice & Poha</button></div>
  <div class="item"><button class="tablinks" onclick="openCity(event, 'Noodles & Pasta')">Noodles & Pasta</button></div>
  <div class="item"><button class="tablinks" onclick="openCity(event, 'Sauces & Ketchup')">Sauces & Ketchup</button></div>
  <div class="item"><button class="tablinks" onclick="openCity(event, 'Soft Drinks')">Soft Drinks</button></div>
  <div class="item"><button class="tablinks" onclick="openCity(event, 'Biscuits & Cookies')">Biscuits & Cookies</button></div>
  <div class="item"><button class="tablinks" onclick="openCity(event, 'Chocolates')">Chocolates</button></div>
</div>  
</div>
...
<div id="Dals & Pulse" class="tabcontent" style="background-color: white;">
</br></br>
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price1, price500, price250, price2 FROM DalsPulse ORDER BY id ASC");
if($results){ 
...
{
$products_item .= <<<EOT
	<form method="post" action="php/cart-dals-pulse.php">
	<div class="media">
        <div class="pull-left"> 
...
<div id="Dry Fruits" class="tabcontent" style="background-color: white;">
</br></br>
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price1, price500, price250, price2 FROM DryFruits ORDER BY id ASC");
if($results){ 
$products_item = '<ul class="products">';
//fetch results set as object and output HTML
while($obj = $results->fetch_object())
{
$products_item .= <<<EOT
	<form method="post" action="php/cart-dry-fruits.php">
	<div class="media">
        <div class="pull-left"> 
           <img style="width: 300px; height: 300px;" class="media-object" src="images/{$obj->product_img_name}" alt="Media Object">
        </div> 
...
<div id="Edible Oils & Ghee" class="tabcontent" style="background-color: white;">
</br></br>
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price1, price500, price250, price2 FROM EdibleOilsGhee ORDER BY id ASC");
if($results){ 
$products_item = '<ul class="products">';
//fetch results set as object and output HTML
while($obj = $results->fetch_object())
{
$products_item .= <<<EOT
	<form method="post" action="php/cart-edible-oils-ghee.php">
	<div class="media">
        <div class="pull-left"> 
           <img style="width: 300px; height: 300px;" class="media-object" src="images/{$obj->product_img_name}" alt="Media Object">
        </div> 
...
<div id="Salt, Sugar & Jaggery" class="tabcontent" style="background-color: white;">
</br></br>
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price1, price500, price250, price2 FROM SaltSugarJaggery ORDER BY id ASC");
if($results){ 
$products_item = '<ul class="products">';
//fetch results set as object and output HTML
while($obj = $results->fetch_object())
{
$products_item .= <<<EOT
	<form method="post" action="php/cart-salt-sugar-jaggery.php">
	<div class="media">
        <div class="pull-left"> 
           <img style="width: 300px; height: 300px;" class="media-object" src="images/{$obj->product_img_name}" alt="Media Object">
        </div> 
...
<div id="Masalas & Spices" class="tabcontent" style="background-color: white;">
</br></br>
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price1, price500, price250, price2 FROM MasalasSpices ORDER BY id ASC");
if($results){ 
$products_item = '<ul class="products">';
//fetch results set as object and output HTML
while($obj = $results->fetch_object())
{
$products_item .= <<<EOT
	<form method="post" action="php/cart-masalas-spices.php">
	<div class="media">
        <div class="pull-left"> 
           <img style="width: 300px; height: 300px;" class="media-object" src="images/{$obj->product_img_name}" alt="Media Object">
        </div> 
...
<div id="Tea & Coffee" class="tabcontent" style="background-color: white;">
</br></br>
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price1, price500, price250, price2 FROM TeaCoffee ORDER BY id ASC");
if($results){ 
$products_item = '<ul class="products">';
//fetch results set as object and output HTML
while($obj = $results->fetch_object())
{
$products_item .= <<<EOT
	<form method="post" action="php/cart-tea-coffee.php">
	<div class="media">
        <div class="pull-left"> 
           <img style="width: 300px; height: 300px;" class="media-object" src="images/{$obj->product_img_name}" alt="Media Object">
        </div> 
...
<div id="Flours & Sooji" class="tabcontent" style="background-color: white;">
</br></br>
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price1, price500, price250, price2 FROM FloursSooji ORDER BY id ASC");
if($results){ 
$products_item = '<ul class="products">';
//fetch results set as object and output HTML
while($obj = $results->fetch_object())
{
$products_item .= <<<EOT
	<form method="post" action="php/cart-flours-sooji.php">
	<div class="media">
        <div class="pull-left"> 
           <img style="width: 300px; height: 300px;" class="media-object" src="images/{$obj->product_img_name}" alt="Media Object">
        </div> 
...
<div id="Rice & Poha" class="tabcontent" style="background-color: white;">
</br></br>
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price1, price500, price250, price2 FROM RicePoha ORDER BY id ASC");
if($results){ 
$products_item = '<ul class="products">';
//fetch results set as object and output HTML
while($obj = $results->fetch_object())
{
$products_item .= <<<EOT
	<form method="post" action="php/cart-rice-poha.php">
	<div class="media">
        <div class="pull-left"> 
           <img style="width: 300px; height: 300px;" class="media-object" src="images/{$obj->product_img_name}" alt="Media Object">
        </div> 
...
<div id="Noodles & Pasta" class="tabcontent" style="background-color: white;">
</br></br>
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price1, price500, price250, price2 FROM NoodlesPasta ORDER BY id ASC");
if($results){ 
$products_item = '<ul class="products">';
//fetch results set as object and output HTML
while($obj = $results->fetch_object())
{
$products_item .= <<<EOT
	<form method="post" action="php/cart-noodles-pasta.php">
	<div class="media">
        <div class="pull-left"> 
           <img style="width: 300px; height: 300px;" class="media-object" src="images/{$obj->product_img_name}" alt="Media Object">
        </div> 
...
<div id="Sauces & Ketchup" class="tabcontent" style="background-color: white;">
</br></br>
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price1, price500, price250, price2 FROM SaucesKetchup ORDER BY id ASC");
if($results){ 
$products_item = '<ul class="products">';
//fetch results set as object and output HTML
while($obj = $results->fetch_object())
{
$products_item .= <<<EOT
	<form method="post" action="php/cart-sauces-ketchup.php">
	<div class="media">
        <div class="pull-left"> 
           <img style="width: 300px; height: 300px;" class="media-object" src="images/{$obj->product_img_name}" alt="Media Object">
        </div> 
...
<div id="Soft Drinks" class="tabcontent" style="background-color: white;">
</br></br>
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price1, price500, price250, price2 FROM SoftDrinks ORDER BY id ASC");
if($results){ 
$products_item = '<ul class="products">';
//fetch results set as object and output HTML
while($obj = $results->fetch_object())
{
$products_item .= <<<EOT
	<form method="post" action="php/cart-soft-drinks.php">
	<div class="media">
        <div class="pull-left"> 
           <img style="width: 300px; height: 300px;" class="media-object" src="images/{$obj->product_img_name}" alt="Media Object">
        </div> 
...
<div id="Chocolates" class="tabcontent" style="background-color: white;">
</br></br>
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price1, price500, price250, price2 FROM Chocolates ORDER BY id ASC");
if($results){ 
$products_item = '<ul class="products">';
//fetch results set as object and output HTML
while($obj = $results->fetch_object())
{
$products_item .= <<<EOT
	<form method="post" action="php/cart-chocolates.php">
	<div class="media">
        <div class="pull-left"> 
           <img style="width: 300px; height: 300px;" class="media-object" src="images/{$obj->product_img_name}" alt="Media Object">
        </div> 
...
<div id="Biscuits & Cookies" class="tabcontent" style="background-color: white;">
</br></br>
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price1, price500, price250, price2 FROM BiscuitsCookies ORDER BY id ASC");
if($results){ 
$products_item = '<ul class="products">';
//fetch results set as object and output HTML
while($obj = $results->fetch_object())
{
$products_item .= <<<EOT
	<form method="post" action="php/cart-biscuits-cookies.php">
	<div class="media">
        <div class="pull-left"> 
           <img style="width: 300px; height: 300px;" class="media-object" src="images/{$obj->product_img_name}" alt="Media Object">
        </div> 
