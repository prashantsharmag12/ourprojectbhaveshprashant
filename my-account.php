...
<html>
<head>
<title>Instamart | My Account</title>
...
<div style="background-color: #FAEBD7; padding-top: 80px; padding-bottom: 80px;">
<?php if (isset($_SESSION['usr_id'])) { ?>
<p align="center"><img src="images/my-account.png" style="width: 35%; border-radius: ; background-color: #FAEBD7"/></p></br>
<p align="center" style="font: 38px arial; color: black;"><strong><?php echo $_SESSION['usr_name']; ?></strong></p>
<p align="center" style="font: 32px arial; color: black;"><?php echo $_SESSION['usr_email']; ?></p></br>
<p align="center"><a href="checkout-login.php"><button type="button" class="btn btn-default" style="color: white; font-size : 35px; background-color: rgb(80,80,80); height: 70px; width: 300px; border: none;">LOGOUT</button></a></p>
<?php } ?>
</div>
